...
const i18n = new I18n({
  en: { 
    ...
    basket: {
      ...
      remove: 'Remove',
      authorize: 'Please log in to view your basket',
    },
    order: {
      ...
      bonuses: 'Bonuses',
      available: 'Available',
      selectStorage: 'Select Warehouse',
    },
    catalog: {
      price: 'Price',
      readMore: 'Read more',
      ...
      amountPlaceholder: 'Amount in warehouse',
  ...
  ru: {
    ...
    basket: {
      ...
      remove: 'Удалить',
      authorize: 'Пожалуйста, авторизуйтесь, чтобы увидеть корзину'
    },
    order: {
    ...
    catalog: {
      ...
      amountPlaceholder: 'Количество на складе',
