...
CREATE TABLE IF NOT EXISTS "public"."orders" (
    ...
    "ord_sh_id" smallint NOT NULL,
    "ord_st_id" smallint NOT NULL,
    "ord_pm_id" smallint NOT NULL,
    "ord_bonuses_used" smallint NOT NULL,
    "ord_bonuses_earned" smallint NOT NULL,
    "ord_final_sum" numeric NOT NULL,
